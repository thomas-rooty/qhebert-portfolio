	...
	return (
		<div className={styles.container}>
			...
			<div className={styles.right}>
				...
				<p>Progressivement, je me suis spécialisé dans la réalisation de vidéos dynamiques.
					Chaque vidéo est soigneusement réfléchie et travaillée de A à Z par mes soins, en commencant par le
					storyboard,
					puis le tournage, le montage, la colorimétrie et le sound design.</p>
